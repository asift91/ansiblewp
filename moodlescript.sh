...
moodle_install() {
  ...
  sudo sed -i "s~dbhost = 'localhost'~dbhost = ${4}~" /home/${3}/ansible_playbook/roles/moodle/templates/config.php >> /home/${3}/var.txt
  sudo sed -i "s~dbuser = 'db_username'~dbuser = ${5}~" /home/${3}/ansible_playbook/roles/moodle/templates/config.php >> /home/${3}/var.txt
