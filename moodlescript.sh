...
moodle_install() {
  ...
  sudo sed -i "s~dbhost: localhost~dbhost: ~” /home/${3}/ansible_playbook/roles/moodle/templates/config.php.j2 >> /home/${3}/var.txt
sudo sed -i "s~dbuser: dbusername~dbuser: ~” /home/${3}/ansible_playbook/roles/moodle/templates/config.php.j2 >> /home/${3}/var.txt
sudo sed -i "s~dbpass: dbpassword~dbpass: ~” /home/${3}/ansible_playbook/roles/moodle/templates/config.php.j2 >> /home/${3}/var.txt
