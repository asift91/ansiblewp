...
moodle_install() {
  ...
  sudo sed -i "s~dbhost: localhost~dbhost: ~” /home/${3}/ansible_playbook/group_vars/all >> /home/${3}/var.txt
  sudo sed -i "s~dbuser: dbusername~dbuser: ~” /home/${3}/ansible_playbook/group_vars/all >> /home/${3}/var.txt
  sudo sed -i "s~dbpass: dbpassword~dbpass: ~” /home/${3}/ansible_playbook/group_vars/all >> /home/${3}/var.txt
